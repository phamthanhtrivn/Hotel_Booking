...
@RestController
@RequestMapping("/api/member/dondatphong")
public class MemberDonDatPhongController {

    private final DonDatPhongService donDatPhongService;
    private final JavaMailSender mailSender;

    public MemberDonDatPhongController(DonDatPhongService donDatPhongService, JavaMailSender mailSender) {
